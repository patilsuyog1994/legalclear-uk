  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px", margin: "4px 0" }}>
        ...
        <span style={{ fontSize: "13px", color: "#999", whiteSpace: "nowrap" }}>or sign in with email</span>
        <div style={{ flex: 1, height: "1px", backgroundColor: "#e5e0d8" }} />
      </div>
    ...
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div style={{ textAlign: "center" }}>
        <Link href="/forgot-password" style={{ fontSize: "13px", color: "#0f6e56", textDecoration: "none" }}>
